		...
		<form method="post" use:enhance>
			<div class="my-3">
				<label class="label" for="username">
					<span>Username</span>
					<input
						class="input variant-soft-tertiary text-white"
						type="text"
						name="username"
						id="username"
					/><br />
			...
			<div class="my-3">
				<label class="label" for="password">
					<span>Password</span>
					<input
						class="input variant-soft-tertiary text-white font-bold"
						type="password"
						name="password"
						id="password"
					/><br />
			...
			<button type="submit" class="btn variant-filled-tertiary my-7 w-full text-gray-800 font-bold">
